      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 h-[calc(100vh-140px)]">
        ...
        <div className="space-y-4 md:space-y-6 overflow-y-auto">
          ...
          <div className="bg-card rounded-lg border p-4 md:p-6">
            ...
            {/* AI Generation Failed Warning */}
            {!location.state?.generatedSections && location.state?.prompt && (
              <div className="text-xs text-destructive bg-destructive/10 border border-destructive/20 p-2 md:p-3 rounded-md mt-3">
                <strong>⚠️ AI Generation Failed:</strong> The website content was not generated by AI. 
                Please go back and try again, or check your OpenAI API configuration.
              </div>
            )}
          </div>
